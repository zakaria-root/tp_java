	...
	<div id="main">
		<div id="header">
			<div id="logo">
				<div id="logo_text">
					...
					<h1>
						<a href="index.html">Tutoriel<span class="logo_colour">J2EE</span></a>
					</h1>
				...
				<div id="logintext">
					...
					if (session.getAttribute("cred") == null) {
						...
						credentialsC cred = (credentialsC) session.getAttribute("cred");
					%>
					Bienvenu <%=cred.getLogin()%>
					| <a href="Logoutcontroler">Déconnexion</a>
		...
		<div id="site_content">
			<div class="sidebar">
				...
				<p>
					Ici nous allons ajouter le salarié le plus recent ajouter au niveau
					de notre base de données<br /> <a href="#">Plus ...</a>
				</p>
				<p></p>
				<h4>Nouveau Département Ajouté</h4>
				<h5>La date</h5>
				<p>
					Ici nous allons mettre le departement avec le plus grand nombre des
					employees<br /> <a href="#">Plus ...</a>
				</p>
